...
export const TEMPLATES = [
    ...
    slots: [
      {
        ...
        sizePct: 0.11, fill: '#ffffff',
        stroke: '#000000', strokePct: 0.22,
        shadow: true, weight: 'normal', transform: 'uppercase',
        defaultText: 'TOP TEXT',
      },
      {
        id: 'bottom',
        x: 0.05, y: 0.83, width: 0.9, align: 'center',
        font: 'Impact, "Anton", "Space Grotesk", sans-serif',
        sizePct: 0.11, fill: '#ffffff',
        stroke: '#000000', strokePct: 0.22,
        shadow: true, weight: 'normal', transform: 'uppercase',
  ...
  },
  {
    ...
    slots: [
      {
        id: 'subtitle',
        x: 0.06, y: 0.85, width: 0.88, align: 'center',
        font: '"Space Grotesk", "Inter", sans-serif',
        sizePct: 0.055, fill: '#ffffff',
        stroke: '#000000', strokePct: 0.18,
        shadow: true, weight: '600', transform: 'none',
  ...
  },
  {
    ...
    slots: [
      {
        id: 'stamp',
        x: 0.04, y: 0.06, width: 0.7, align: 'left',
        font: '"Space Grotesk", "Inter", sans-serif',
        sizePct: 0.10, fill: '#c6ff3d',
  ...
  },
  {
    ...
    slots: [
      ...
      {
        id: 'dek',
        x: 0.05, y: 0.22, width: 0.9, align: 'left',
        font: '"Inter", system-ui, sans-serif',
        sizePct: 0.055, fill: '#ffffff',
